...
from afni_python import lib_uber_subject as USUBJ
from afni_python import lib_uber_proc as UPROC
from afni_python import lib_qt_gui as QLIB
from afni_python import gui_uber_subj as GUS    # single subject GUI
...
class MainWindow(QtGui.QMainWindow):
   ...
   def read_settings_file(self):
      if not UPROC.in_home_dir(): # get any local settings file
   ...
   def uberHelp(self):
      ...
      win = QLIB.TextWindow(text=UPROC.g_help_string,
                            title='uber_proc.py help', parent=self)
